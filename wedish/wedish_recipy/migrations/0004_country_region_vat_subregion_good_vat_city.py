...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('wedish_recipy', '0003_alter_goodingradient_quantity'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wedish_recipy.country')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geoname_code', models.CharField(blank=True, db_index=True, max_length=50, null=True)),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wedish_recipy.country')),
                ('region', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='wedish_recipy.region')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='good',
            name='vat',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='wedish_recipy.vat', verbose_name='VAT'),
        ),
        migrations.CreateModel(
            name='City',
            fields=[
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wedish_recipy.country')),
                ('region', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='wedish_recipy.region')),
                ('subregion', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='wedish_recipy.subregion')),
            ],
            options={
