...
class Space(models.Model):
    ...
    space_category = models.ForeignKey('SpaceCategory', on_delete=models.SET_NULL, null=True, verbose_name='Space', related_name='space_categories')
...
class Table(models.Model):
    public_identifier = models.IntegerChoices()
